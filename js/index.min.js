...
$(function () {
   ...
   /* function Interest() {
    ...
    function calcByAreaAndPrice() {
        ...
        var houseMoneyTotal = parseFloat($("#myform input[name=x1]").val()) + parseFloat($("#myform input[name=x2]").val())+ parseFloat($("#myform input[name=x3]").val())+ parseFloat($("#myform input[name=x4]").val())+ parseFloat($("#myform input[name=x5]").val())+ parseFloat($("#myform input[name=x6]").val())
			                 ;
        houseMoneyTotal=houseMoneyTotal/1000-0.5;
